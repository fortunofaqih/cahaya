...
function sortUrlR($column, $currentSort, $currentDir, $startDate, $endDate) {
    ...
    return 'index.php?' . http_build_query([
        'page' => 'register_penjualan_global_detail',
...
while($item=mysqli_fetch_assoc($res)){
    ...
    // data invoice tetap tampil tetapi tidak diakumulasi ke kategori produk.
...
<div class="rpg-wrap">
    <div class="rpg-head">
        <h5>Register Penjualan Global Detail</h5>
        <a class="btn-vs btn-success"
           href="modul/transaksi/cetak_register_penjualan_global_detail.php?start_date=<?=urlencode(fmtDateR($startDate))?>&end_date=<?=urlencode(fmtDateR($endDate))?>&sort=<?=urlencode($sort)?>&dir=<?=urlencode($dir)?>"
           target="_blank">Cetak Register</a>
    </div>

    <div class="filter-card">
        <form method="GET" action="index.php">
            <input type="hidden" name="page" value="register_penjualan_global_detail">
            ...
            <div class="filter-grid">
                ...
                <div style="display:flex;gap:6px">
                    ...
                    <a href="index.php?page=register_penjualan_global_detail" class="btn-vs btn-secondary">Reset</a>
                </div>
            </div>
        </form>
    </div>
