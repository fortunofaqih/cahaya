...
.report-table tbody tr:hover td{background:#fff1f1}
...
<div class="rpg-wrap">
    ...
    <div class="rpg-head">
        <h5>Register Penjualan Global Return</h5>
    ...
    <div class="filter-card">
        <form method="GET" action="index.php">
            <input type="hidden" name="page" value="register_penjualan_global_return">
            ...
            <div class="filter-grid">
                ...
                <div style="display:flex;gap:6px">
                    ...
                    <a href="index.php?page=register_penjualan_global_return"
        ...
        <table class="report-table">
            <thead>
                <tr>
                    <th rowspan="2">
                        <a class="sort-link"
                           href="<?=h(sortUrlR('shipping_no',$sort,$dir,$startDate,$endDate))?>"
                           title="Urutkan Shipping No.">
                            SHIPPING NO.
                            <span class="sort-icon"><?=h(sortIconR('shipping_no',$sort,$dir))?></span>
                        </a>
                    </th>

                    <th rowspan="2">
                        <a class="sort-link"
                           href="<?=h(sortUrlR('invoice_no',$sort,$dir,$startDate,$endDate))?>"
                           title="Urutkan Invoice No.">
                            INVOICE NO.
                            <span class="sort-icon"><?=h(sortIconR('invoice_no',$sort,$dir))?></span>
                        </a>
                    </th>
